...
![1680314152822](../pic/1680314152822.png)
...
![1680315652403](../pic/1680315652403.png)
...
![image-20230510203951389](../pic/image-20230510203951389.png)

![1680317605797](../pic/1680317605797.png)

## 05-文字控制属性

<img src="../pic/image-20230510204058940.png" alt="image-20230510204058940" style="zoom:50%;" />
...
![image-20230515215848971](../pic/image-20230515215848971.png)
...
![1680318569852](../pic/1680318569852.png)
...
![1680318751246](../pic/1680318751246.png)
...
![1680319376438](../pic/1680319376438.png)
...
> ![](../pic/2023-05-11-11-10-14-image.png)
> 
> ![](../pic/2023-05-11-11-12-03-image.png)
> 
> ![](../pic/2023-05-11-11-13-47-image.png)
...
> 因为盒子太大了，所以会复制：
> 
> ![](../pic/2023-05-11-11-20-30-image.png)
...
![](../pic/2023-05-11-13-48-09-image.png)
...
![1680321408957](../pic/1680321408957.png)
...
![1680330935635](../pic/1680330935635.png)
...
结论：给盒子加 **<mark>border / padding</mark>** 会撑大盒子
...
![1680331503466](../pic/1680331503466.png)
...
![1680331580746](../pic/1680331580746.png)
...
![](../pic/2023-05-11-17-37-24-image.png)

![](../pic/2023-05-11-17-37-44-image.png)

![](../pic/2023-05-11-17-38-24-image.png)
...
![1680335016853](../pic/1680335016853.png)
...
![](../pic/2023-05-15-15-26-14-image.png)
...
2. 标签使用字体图标类名
   ...
   ![image-20230515201211599](../pic/image-20230515201211599.png)
   
   ![image-20230515200140692](../pic/image-20230515200140692.png)
   
   ![image-20230515200524672](../pic/image-20230515200524672.png)
...
![image-20230515203031433](../pic/image-20230515203031433.png)![image-20230515203152404](../pic/image-20230515203152404.png)
...
![image-20230515203812835](../pic/image-20230515203812835.png)
...
![image-20230515203851033](../pic/image-20230515203851033.png)

![image-20230515203945014](../pic/image-20230515203945014.png)
...
![image-20230516173117960](../pic/image-20230516173117960.png)

![动画](../pic/%E5%8A%A8%E7%94%BB.gif)
...
<head>
    ...
    <style>
        ...
        .father:hover .son{
            ...
            /* 下面这个50%和100%都是参照son盒子的50%进行移动， */
            /* transform: translate(50%,100%); */
            /* 只写一个值，表示沿着X轴移动 */
            /* transform: translate(200px); */
            /* 可以单独设置X或Y轴的移动距离 */
            /* transform: translateX(200px); */
            /* 但是这俩（translateX，translateY）不能组合起来使用，会覆盖 */
...
![image-20230517093928167](../pic/image-20230517093928167.png)
...
![动画](../pic/%E5%8A%A8%E7%94%BB-16843115222421.gif)
...
<head>
    ...
    <style>
        ...
        .box:hover .img{
            /* 先平移再旋转，
                不能先旋转再平移，因为旋转会改变坐标轴向，而多重转换会以第一种转换形态的坐标轴为准
            */
...
![动画](../pic/%E5%8A%A8%E7%94%BB-16843133066973.gif)
...
```css
transform: skew(xxxdeg);
```

取值：角度度数 deg

![image-20230517165826880](../pic/image-20230517165826880.png)
...
![image-20230517170045295](../pic/image-20230517170045295.png)
...
![image-20230517182137769](../pic/image-20230517182137769.png)
...
![image-20230517182731338](../pic/image-20230517182731338.png)

 ![image-20230517183733119](../pic/image-20230517183733119.png)
...
![image-20230517191008296](../pic/image-20230517191008296.png)

### 平移

```css
transform: translate3d(x, y, z);/*如果写这个，必须三个参数都写，要不然不会生效*/
...
![动画](../pic/%E5%8A%A8%E7%94%BB-16843224516115.gif)
...
![动画](../pic/%E5%8A%A8%E7%94%BB-16843228522127.gif)
...
![image-20230517193124509](../pic/image-20230517193124509.png)
...
![动画](../pic/%E5%8A%A8%E7%94%BB-16843244404389.gif)
...
<head>
    ...
    <style>
        .cube{
            ...
            margin: 100px auto;
            transition: all 1s;
            /* 第一步，1. 父元素添加transform-style:preserve-3d */
...
![image-20230517200006544](../pic/image-20230517200006544.png)
...
![动画](../pic/%E5%8A%A8%E7%94%BB-168432539364611.gif)
...
![image-20230517203419942](../pic/image-20230517203419942.png)
  ...
  <head>
    ...
    <style>
      .box {
        ...
        /* 
        动画执行完毕时的状态， 
        forwards：动画执行完毕后停留在结束状态； 
        backwards：动画执行完毕后停留在开始状态（默认） 
        */
...
![image-20230517204335407](../pic/image-20230517204335407.png)

使用：

![image-20230517204516363](../pic/image-20230517204516363.png)

![image-20230517204642443](../pic/image-20230517204642443.png)
...
> 无缝动画原理：复制开头图片到结尾位置（图片累加宽度 = 区域宽度）也就是说一个框里面可以容纳三张图片，然后你需要复制三张图片到最后
...
![image-20230517230645124](../pic/image-20230517230645124.png)
...
![image-20230518093833421](../pic/image-20230518093833421.png)

html:

![image-20230518093915264](../pic/image-20230518093915264.png)

现在都是基于iPhone6/7/8进行设计的 也就是说：

![image-20230518094106024](../pic/image-20230518094106024.png)
  ...
  <head>
    ...
    <style>
      * {
      ...
      .toolbar {
        /*fixed布局是行内块，宽度可以随着内容撑开，也可以指定宽度*/
        position: fixed;
        left: 0;
        bottom: 0;
        /*可以在这里指定宽度为100%，之后不管是分辨率多少都可以撑满*/
        width: 100%;
        height: 50px;
        background-color: pink;
      }
...
![image-20230518094809534](../pic/image-20230518094809534.png)
...
![image-20230518095837453](../pic/image-20230518095837453.png)
...
```css
/*
视口宽度为375的时候，网页的背景色是绿色，
如果不为375，这个css就不会生效
需要注意的是，这个375是跟你的屏幕的缩放比有关系的，比如你1920x1080，但是开了缩放比是125%，那他仍然不会生效，现在目前还没办法解决这个问题，js可以解决，等解决了回来填坑
*/
@media (width:375px) {
  html {
    background-color: green;
...
![image-20230518101037522](../pic/image-20230518101037522.png)

![image-20230518101156841](../pic/image-20230518101156841.png)
...
核心原理就是**根据不同的视口宽度给网页中 html 根节点设置不同的 font-size。**
...
![image-20230518102013441](../pic/image-20230518102013441.png)
...
![image-20230518104320343](../pic/image-20230518104320343.png)
...
![image-20230518104926838](../pic/image-20230518104926838.png)

![image-20230518105220071](../pic/image-20230518105220071.png)
...
![image-20230518110151681](../pic/image-20230518110151681.png)

![image-20230518110233072](../pic/image-20230518110233072.png)

### 禁止导出

写法：在 less 文件第一行添加: ` // out: false`

![image-20230518115701148](../pic/image-20230518115701148.png)
...
![image-20230518134446226](../pic/image-20230518134446226.png)

![image-20230518135010031](../pic/image-20230518135010031.png)
...
![image-20230518141301134](../pic/image-20230518141301134.png)
...
![image-20230518171951151](../pic/image-20230518171951151.png)
...
![image-20230518192049895](../pic/image-20230518192049895.png)
...
![image-20230519093619268](../pic/image-20230519093619268.png)
...
![动画](../pic/%E5%8A%A8%E7%94%BB-16844712219291.gif)
...
![image-20230519125407084](../pic/image-20230519125407084.png)
...
![image-20230519130131086](../pic/image-20230519130131086.png)![image-20230519130153452](../pic/image-20230519130153452.png)

![image-20230519130538854](../pic/image-20230519130538854.png)
...
![image-20230519131221516](../pic/image-20230519131221516.png)![image-20230519131331813](../pic/image-20230519131331813.png)![image-20230519131348219](../pic/image-20230519131348219.png)![image-20230519131754902](../pic/image-20230519131754902.png)![image-20230519131903354](../pic/image-20230519131903354.png)
...
3. 调用 CSS 类名（图标对应的类名）
   ...
   ![image-20230519155941156](../pic/image-20230519155941156.png)
